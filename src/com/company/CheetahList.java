...
public class CheetahList {
    ...
    public ArrayList<Cheetah> getListOfCheetahs() {
        return listOfCheetahs;
    }

    public void setListOfCheetahs(ArrayList<Cheetah> listOfCheetahs) {
        this.listOfCheetahs = listOfCheetahs;
    }
